...
impl From<Vertex> for Entry {
    fn from(val: Vertex) -> Self {
        Entry::V(val)
    }
}

impl From<Edge> for Entry {
    fn from(val: Edge) -> Self {
        Entry::E(val)
    }
}

impl From<GraphPath> for Entry {
    fn from(val: GraphPath) -> Self {
        Entry::P(val)
    }
}

impl From<VertexOrEdge> for Entry {
    fn from(val: VertexOrEdge) -> Self {
        match val {
...
impl From<Object> for Entry {
    fn from(val: Object) -> Self {
        Entry::OffGraph(val)
    }
}

impl From<Intersection> for Entry {
    fn from(val: Intersection) -> Self {
        Entry::Intersection(val)
    }
}
...
impl<E> RecordExpandIter<E> {
    pub fn new(origin: Record, tag: Option<&KeyId>, children: DynIter<E>) -> Self {
        RecordExpandIter { tag: tag.copied(), origin, children }
    }
}
